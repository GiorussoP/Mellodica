...
public:
  ...
  void DrawMeshesInstanced(const std::vector<MeshComponent *> &meshes,
                           RendererMode mode);
  ...
  void DrawSpritesInstanced(const std::vector<SpriteComponent *> &sprites,
                            RendererMode mode);
  ...
  // Batch rendering - set frame-level uniforms once before drawing multiple
  // objects
