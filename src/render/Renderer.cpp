...
Renderer::Renderer()
    : mViewMatrix(Matrix4::Identity), mProjectionMatrix(Matrix4::Identity), mMeshShader(nullptr), mSpriteShader(nullptr), mFramebufferShader(nullptr), mHUDShader(nullptr), mBloomBlurShader(nullptr), mSpriteQuad(nullptr), mScreenQuad(nullptr), mFramebuffer(0), mFramebufferTexture(0), mFramebufferDepthStencil(0), mFramebufferWidth(320), mFramebufferHeight(240), mBloomFramebuffer(0), mBloomTexture(0), mBloomDepthStencil(0), mBlurTexture1(0), mBlurTexture2(0), mBlurFramebuffer1(0), mBlurFramebuffer2(0), mIsDark(true)
{
}
