...
#include "../../../include/UI/Screen/PauseScreen.hpp"
#include "AssetLoader.hpp"

#include "../../../include/Game.hpp"
#include "../../../include/UI/UIButton.hpp"
#include "../../../include/scenes/MainMenu.hpp"
#include "../../../include/MIDI/MIDIPlayer.hpp"
#include <SDL2/SDL.h>

PauseScreen::PauseScreen(Game* game) : UIScreen(game, "fonts/MedodicaRegular.otf") {
    mGame->SetPaused(true);
    MIDIPlayer::pause();

    auto btnResume = AddButton(getAssetPath("sprites/scenes/startbutton160x40.png"), [this]() {
        Close();
    });
    ...
    auto btnQuit = AddButton(getAssetPath("sprites/scenes/quitbutton160x40.png"), [this]() {
...
void PauseScreen::HandleKeyPress(int key) {
    if (key == SDLK_UP || key == SDLK_w) {
        if (mSelectedButton > 0) {
            ...
            MIDIPlayer::playSequence({{0.0f, 15, 92, true, 120}, {0.05f, 15, 92, false}});
        }
        ...
        if (mSelectedButton >= 0 && mSelectedButton < static_cast<int>(mHudButtons.size())) {
