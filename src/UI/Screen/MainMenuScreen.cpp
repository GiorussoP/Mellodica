...
MainMenuScreen::MainMenuScreen(class Game *game, const std::string &fontName)
  ...
  auto mB1 =
      AddButton(getAssetPath("sprites/scenes/startbutton160x40.png"), [this] {
  ...
  mB1->ButtonSetScale(Vector3(0.8f, 0.5f, 0.0f));
  mB1->ButtonSetPosition(Vector3(0.0f, 0.25f, 0.0f));

  auto mB2 = AddButton(getAssetPath("sprites/scenes/quitbutton160x40.png"),
                       [this] { mGame->Quit(); });
  SDL_Log("Button 2 Added!");
  mB2->ButtonSetScale(Vector3(0.8f, 0.5f, 0.0f));
  mB2->ButtonSetPosition(Vector3(0.0f, -0.2f, 0.0f));

  auto image =
      AddImageOrElement(getAssetPath("sprites/scenes/title-screen.png"));
